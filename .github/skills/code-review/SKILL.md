...
- Generated catalog changes remain on per-run `automation/gallery-content-updates-<run-id>` branches in draft pull requests. Automation must never approve, merge, or enable automerge.
