...
export default function NavbarMobilePrimaryMenu() {
  ...
  const hasRealNavItems = Array.isArray(items) && items.some((it) => it.type !== 'custom-NavbarButton' && it.type !== 'search');
  ...
  return (
    <ul className="menu__list">
      ...
      <li className="menu__list-item">
        ...
        <ul className="menu__list">
          <li className="menu__list-item"><a className="menu__link" href="#documentation" onClick={(e)=>handleFilterNavigate(e,'documentation,concepts,how-to,tutorial')}>Documentation</a></li>
      ...
      <li className="menu__list-item">
        <Link className="menu__link" to="#quick-links" onClick={(e)=>handleScroll(e,'#quick-links')}>Quick Links</Link>
      </li>
      <li className="menu__list-item">
        <Link className="menu__link" to="#community-support" onClick={(e)=>handleScroll(e,'#community-support')}>Community & Support</Link>
      </li>
    </ul>
  );
}
