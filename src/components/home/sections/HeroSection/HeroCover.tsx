...
export default function HeroCover() {
  ...
  return (
    <div className={styles.coverPageContainer}>
      <div className={styles.coverPageAreaContainer} style={{ backgroundImage: `url(${bgUrl})` }}>
        <div className={styles.coverPageArea}>
          <div className={styles.titleSection}>
            <span className={styles.heroTextWrapper}>
              ...
              <Title3 className={styles.greyText}>{HERO_SUB_DESCRIPTION}</Title3>
            </span>

            <Title3 className={styles.centeredDescription}>{HERO_DESCRIPTION}</Title3>
            ...
            <CoverCardsRow
              ...
              onResourceLibrary={(tags) => navigateToResourceLibrary(tags ?? [])}
            />
          </div>
        </div>
      </div>
